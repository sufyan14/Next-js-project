...
async function Prediction({ params }: Params) {
  ...
  return (
    <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl m-3 p-4">
      <div className="p-8">
        <div className="text-center uppercase tracking-wide text-sm text-[#22c55e] font-semibold">
          Personal Info
        </div>
        <div className="text-center block mt-1 text-lg leading-tight font-medium text-black">
          Age: {age?.age}
        </div>
        <div className="text-center block mt-1 text-lg leading-tight font-medium text-black">
